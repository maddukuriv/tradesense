...
bse_smallcap = [
    ...
    'ASTRAZEN.NS', 'ATULAUTO.NS', 'ATUL.NS', 'AURIONPRO.NS',  'AUTOAXLES.NS', 'ASAL.NS', 'AVADHSUGAR.NS', 'AVALON.NS',
     'AVANTIFEED.NS', 'AVTNPL.NS', 'AXISCADES.NS', 'AZAD.NS', 'BLKASHYAP.NS', 'BAJAJCON.NS', 'BAJAJELEC.NS',
    'BAJAJHCARE.NS', 'BAJAJHIND.NS', 'BALAMINES.NS', 'BALMLAWRIE.NS', 'BLIL.BO', 'BALRAMCHIN.NS',
    ...
    'DCMSHRIRAM.NS', 'DCW.NS', 'DCXINDIA.NS',  'DECCANCE.NS', 'DEEPINDS.NS', 'DEEPAKFERT.NS', 'DELTACORP.NS',
    ...
    'EIHAHOTELS.NS', 'EIHOTEL.NS',  'ELECON.NS', 'EMIL.NS', 'ELECTCAST.NS', 'ELGIEQUIP.NS', 'ELIN.NS',
    'ELPROINTL.BO', 'EMAMIPAP.NS', 'EMSLIMITED.NS', 'EMUDHRA.NS', 'ENGINERSIN.NS', 'ENIL.NS', 'EPIGRAL.NS', 'EPL.NS',
    'EQUITASBNK.NS', 'ERIS.NS', 'ESABINDIA.NS', 'ESAFSFB.NS', 'ESCORTS.NS', 'ESTER.NS', 'ETHOSLTD.NS',
    ...
    'KRBL.NS', 'KIMS.NS', 'KRSNAA.NS', 'KSB.NS', 'KSOLVES.NS', 'KUANTUM.NS', 'LAOPALA.NS', 'LAXMIMACH.NS', 
    'LANDMARK.NS', 'LATENTVIEW.NS', 'LXCHEM.NS', 'LEMONTREE.NS', 'LGBBROSLTD.NS', 'LIKHITHA.NS', 'LINC.NS', 'LINCOLN.NS',
    'LLOYDSENGG.NS', 'LLOYDSME.NS', 'LTFOODS.NS', 'LUMAXTECH.NS', 'LUMAXIND.NS', 'MMFL.NS', 'MKPL.NS',
     'MGL.NS', 'MTNL.NS', 'MAHSCOOTER.NS', 'MAHSEAMLES.NS', 'MHRIL.NS', 'MAHLIFE.NS', 'MAHLOG.NS', 'MANINDS.NS',
    ...
    'POLYPLEX.NS', 'POONAWALLA.NS', 'POWERMECH.NS', 'PRAJIND.NS', 'PRAKASHSTL.NS', 'DIAMONDYD.NS',  'PRECAM.NS',
    'PRECWIRE.NS', 'PRESTIGE.NS', 'PRICOLLTD.NS', 'PFOCUS.NS', 'PRINCEPIPE.NS', 'PRSMJOHNSN.NS', 'PRIVISCL.NS',
    'PGHL.NS', 'PROTEAN.BO', 'PRUDENT.NS', 'PSPPROJECT.NS', 'PFS.NS', 'PTC.NS', 'PTCIL.BO', 'PSB.NS', 'PUNJABCHEM.NS',
    'PURVA.NS', 'PVRINOX.NS', 'QUESS.NS', 'QUICKHEAL.NS',  'RRKABEL.NS', 'RSYSTEMS.NS', 'RACLGEAR.BO', 'RADIANTCMS.NS',
    ...
    'SCHNEIDER.NS', 'SEAMECLTD.NS', 'SENCO.NS', 'SEPC.NS', 'SEQUENT.NS', 'SESHAPAPER.NS',  'SHAILY.NS',
    ...
    'SPECIALITY.NS', 'SPENCERS.NS',  'SPORTKING.NS', 'SRHHYPOLTD.NS', 'SAINTGOBAIN.BO', 'STARCEMENT.NS',
    ...
    'TVSHLTD.NS', 'TVSSRICHAK.NS', 'TVSSCS.NS', 'UFLEX.NS', 'UGARSUGAR.NS', 'UGROCAP.NS', 'UJJIVANSFB.NS',
    ...
    'VSTIND.NS',   'WELCORP.NS', 'WELENT.NS', 'WELSPUNLIV.NS', 'WENDT.NS',
