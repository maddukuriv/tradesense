...
def main_menu():
    ...
    menu_options = [f"{st.session_state.username}'s Portfolio",f"{st.session_state.username}'s Watchlist", "Stock Screener",  "Stock Watch", "Technical Analysis", "Stock Price Forecasting",
...
if not st.session_state.logged_in:
    ...
    if choice:
        ...
        # 'Market Stats' code -------------------------------------------------------------------------------------------    
            ...
            # Sidebar for user input
            tickers = st.sidebar.multiselect("Enter Stock Symbols", options=[
