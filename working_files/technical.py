...
def stock_analysis_app():
    ...
    if submenu == "Technical Analysis":
        ...
        def calculate_indicators(df):
            ...
            df['Advance_Decline_Line'] = df['Close'] > df['Open']
            ...
            if view_option == 'Visualization':
                ...
                for key, value in scores.items():
                    ...
                    with col1:
                        ...
                        # Split the indicator and its description
                        split_details = [item.split(": ") for item in details[key].split("; ")[:-1]]
                        
                        # Convert the list of lists into a DataFrame with two columns
                        detail_table = pd.DataFrame(split_details, columns=['Indicator', 'Description'])
                ...
                if ticker:
                    ...
                    if company_name:
                        with st.spinner("Fetching news..."):
                            articles = fetch_news(company_name, end_date - timedelta(days=29), end_date)
